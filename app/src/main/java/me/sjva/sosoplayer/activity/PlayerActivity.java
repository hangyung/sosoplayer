...
//          new ConfirmDialog(this, getString(R.string.error_title))
  ...
  protected boolean initializePlayer() {
    ...
    switch (fileInfoType) {
      case KEY_FILE_INFO_TYPE_COMMON: {
          ...
          currentMediaKey = fileInfo.getCurrentMediaKey();
  ...
  @Override
  public void onVolumeSettingsButtonClick(View anchor) {
    showVolumeSettings(anchor);
  }
...
//    settingsView.setAdapter(settingsAdapter);
  ...
  private void showVolumeSettings(View anchor) {
