 ...
 */
public class FfmpegRenderersFactory implements RenderersFactory {
  ...
  @DefaultRenderersFactory.ExtensionRendererMode private int extensionRendererMode;
  ...
  /**
   * @deprecated Use {@link #FfmpegRenderersFactory(Context)} and {@link
   *     #setExtensionRendererMode(int)}.
   */
  @Deprecated
  @SuppressWarnings("deprecation")
  public FfmpegRenderersFactory(
  ...
  /**
   * @deprecated Use {@link #FfmpegRenderersFactory(Context)}, {@link
   ...
   */
  public FfmpegRenderersFactory setExtensionRendererMode(
      @DefaultRenderersFactory.ExtensionRendererMode int extensionRendererMode) {
    this.extensionRendererMode = extensionRendererMode;
    return this;
  }
   ...
   * @return This factory, for convenience.
   */
  public FfmpegRenderersFactory experimentalSetAsynchronousBufferQueueingEnabled(boolean enabled) {
   ...
   * @return This factory, for convenience.
   */
  public FfmpegRenderersFactory experimentalSetForceAsyncQueueingSynchronizationWorkaround(
      boolean enabled) {
   ...
   * @return This factory, for convenience.
   */
  public FfmpegRenderersFactory experimentalSetSynchronizeCodecInteractionsWithQueueingEnabled(
      boolean enabled) {
   ...
   * @return This factory, for convenience.
   */
  public FfmpegRenderersFactory setEnableDecoderFallback(boolean enableDecoderFallback) {
   ...
   * @return This factory, for convenience.
   */
  public FfmpegRenderersFactory setMediaCodecSelector(MediaCodecSelector mediaCodecSelector) {
   ...
   * @return This factory, for convenience.
   */
  public FfmpegRenderersFactory setEnableAudioFloatOutput(boolean enableFloatOutput) {
   ...
   * @return This factory, for convenience.
   */
  public FfmpegRenderersFactory setEnableAudioOffload(boolean enableOffload) {
   ...
   * @return This factory, for convenience.
   */
  public FfmpegRenderersFactory setEnableAudioTrackPlaybackParams(
   ...
   * @return This factory, for convenience.
   */
  public FfmpegRenderersFactory setAllowedVideoJoiningTimeMs(long allowedVideoJoiningTimeMs) {
    this.allowedVideoJoiningTimeMs = allowedVideoJoiningTimeMs;
    return this;
  }
...
//    }
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      Class<?> clazz = Class.forName(
          "com.google.android.exoplayer2.ext.ffmpeg2.FfmpegVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              Handler.class,
  ...
  protected void buildAudioRenderers(
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("com.google.android.exoplayer2.ext.ffmpeg2.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              Handler.class,
              AudioRendererEventListener.class,
  ...
  protected void buildTextRenderers(
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("com.google.android.exoplayer2.ext.soso.SosoTextRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              TextOutput.class,
              Looper.class);
      ...
      out.add(renderer);
      Log.i(TAG, "Loaded SosoTextRenderer.");
    } catch (ClassNotFoundException e) {
      // Expected if the app was built without the extension.
