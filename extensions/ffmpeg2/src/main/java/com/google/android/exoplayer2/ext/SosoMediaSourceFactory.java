 ...
 */
public final class SosoMediaSourceFactory implements MediaSourceFactory {
  ...
  private static final String TAG = "SosoMediaSourceFactory";
  ...
  private boolean useFFmpegExtractor;
   ...
   */
  public SosoMediaSourceFactory(Context context) {
   ...
   *     its container.
   */
  public SosoMediaSourceFactory(Context context, ExtractorsFactory extractorsFactory) {
    this(new DefaultDataSourceFactory(context), extractorsFactory, true);
  }
   ...
   */
  public SosoMediaSourceFactory(DataSource.Factory dataSourceFactory) {
   ...
   *     its container.
   */
  public SosoMediaSourceFactory(
      DataSource.Factory dataSourceFactory, ExtractorsFactory extractorsFactory, boolean useFFmpegExtractor) {
    this.dataSourceFactory = dataSourceFactory;
    this.useFFmpegExtractor = useFFmpegExtractor;
    mediaSourceFactories = loadDelegates(dataSourceFactory, extractorsFactory, useFFmpegExtractor);
   ...
   */
  public SosoMediaSourceFactory setAdsLoaderProvider(
   ...
   * @return This factory, for convenience.
   */
  public SosoMediaSourceFactory setAdViewProvider(@Nullable AdViewProvider adViewProvider) {
   ...
   * @return This factory, for convenience.
   */
  public SosoMediaSourceFactory setLiveTargetOffsetMs(long liveTargetOffsetMs) {
   ...
   * @return This factory, for convenience.
   */
  public SosoMediaSourceFactory setLiveMinOffsetMs(long liveMinOffsetMs) {
   ...
   * @return This factory, for convenience.
   */
  public SosoMediaSourceFactory setLiveMaxOffsetMs(long liveMaxOffsetMs) {
   ...
   * @return This factory, for convenience.
   */
  public SosoMediaSourceFactory setLiveMinSpeed(float minSpeed) {
   ...
   * @return This factory, for convenience.
   */
  public SosoMediaSourceFactory setLiveMaxSpeed(float maxSpeed) {
  ...
  @Override
  public SosoMediaSourceFactory setDrmHttpDataSourceFactory(
  ...
  @SuppressWarnings("deprecation") // Calling through to the same deprecated method.
  @Override
  public SosoMediaSourceFactory setDrmUserAgent(@Nullable String userAgent) {
    for (int i = 0; i < mediaSourceFactories.size(); i++) {
  ...
  @SuppressWarnings("deprecation") // Calling through to the same deprecated method.
  @Override
  public SosoMediaSourceFactory setDrmSessionManager(
  ...
  @Override
  public SosoMediaSourceFactory setDrmSessionManagerProvider(
  ...
  @Override
  public SosoMediaSourceFactory setLoadErrorHandlingPolicy(
  ...
  @Deprecated
  @Override
  public SosoMediaSourceFactory setStreamKeys(@Nullable List<StreamKey> streamKeys) {
    for (int i = 0; i < mediaSourceFactories.size(); i++) {
  ...
  private static SparseArray<MediaSourceFactory> loadDelegates(
    ...
    if (useFFmpegExtractor) {
      try {
        factories.put(
                C.TYPE_OTHER, new SosoMediaSource.Factory(dataSourceFactory));
