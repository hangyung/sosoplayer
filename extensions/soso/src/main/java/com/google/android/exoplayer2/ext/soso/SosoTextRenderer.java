 ...
 */
public final class SosoTextRenderer extends BaseRenderer implements Callback {
  public static final int MSG_ENCODING = C.MSG_CUSTOM_BASE + 100;
  private static final String TAG = "SosoTextRenderer";
   ...
   */
  public SosoTextRenderer(TextOutput output, @Nullable Looper outputLooper) {
    this(output, outputLooper, new SosoSubtitleDecoderFactory());
  }
  ...
  private void initDecoder() {
    ...
    if (decoderFactory instanceof SosoSubtitleDecoderFactory){
      SosoSubtitleDecoderFactory sosoSubtitleDecoderFactory = (SosoSubtitleDecoderFactory)decoderFactory;
      decoder = sosoSubtitleDecoderFactory.createDecoder(checkNotNull(streamFormat));
    } else {
