...
//    minimalControls = styledPlayerControlView.findViewById(R.id.soso_minimal_controls);

    // Relating to Bottom Bar View
    bottomBar = styledPlayerControlView.findViewById(R.id.soso_bottom_bar);

    // Relating to Bottom Bar Left View
    timeView = styledPlayerControlView.findViewById(R.id.soso_time);
    timeBar = styledPlayerControlView.findViewById(R.id.soso_progress);
...
//            }
    ...
    float translationYForProgressBar =
        resources.getDimension(R.dimen.soso_styled_bottom_bar_height)
            - resources.getDimension(R.dimen.soso_styled_progress_bar_height);
    float translationYForNoBars = resources.getDimension(R.dimen.soso_styled_bottom_bar_height);
...
//    resetHideCallbacks();
//    if (v.getId() == R.id.soso_overflow_show) {
//      overflowShowAnimator.start();
//    } else if (v.getId() == R.id.soso_overflow_hide) {
...
//    }
    ...
    if (timeBar != null) {
      ...
      int timeBarMarginBottom =
          styledPlayerControlView
              .getResources()
              .getDimensionPixelSize(R.dimen.soso_styled_progress_margin_bottom);
  ...
  private boolean shouldHideInMinimalMode(View button) {
    int id = button.getId();
    return (id == R.id.soso_bottom_bar
        || id == R.id.soso_prev
        || id == R.id.soso_next
        || id == R.id.soso_rew_with_amount
        || id == R.id.soso_ffwd_with_amount
        || id == R.id.soso_audio_track
        || id == R.id.soso_subtitle
        || id == R.id.soso_pip
        || id == R.id.soso_settings);
  }
  ...
  private void onLayoutWidthChanged() {
    ...
    int occupiedWidth = 0;//getWidthWithMargins(timeView);
