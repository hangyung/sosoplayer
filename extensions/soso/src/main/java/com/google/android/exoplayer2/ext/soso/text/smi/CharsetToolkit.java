...
public class CharsetToolkit
{
  ...
  public static Charset guessEncoding(byte[] orgbuffer, int bufferLength) throws FileNotFoundException, IOException
  {

    byte[] buffer = new byte[bufferLength];

    System.arraycopy(orgbuffer, 0, buffer, 0, bufferLength);
