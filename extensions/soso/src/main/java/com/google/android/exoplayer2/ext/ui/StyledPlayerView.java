...
import com.google.android.exoplayer2.ext.ui.AspectRatioFrameLayout.ResizeMode;
import com.google.android.exoplayer2.ext.ui.spherical.SingleTapListener;
import com.google.android.exoplayer2.ext.ui.spherical.SphericalGLSurfaceView;
 ...
 *         <li>Default: {@code true}
 *       </ul>
 *   <li><b>{@code shutter_background_color}</b> - The background color of the {@code soso_shutter}
 *       view.
 *       <ul>
 ...
 *       <ul>
 *         <li>Corresponding method: None
 *         <li>Default: {@code R.layout.soso_styled_player_view}
 *       </ul>
 ...
 *       <ul>
 *         <li>Corresponding method: None
 *         <li>Default: {@code R.layout.soso_styled_player_control_view}
 *       </ul>
 ...
 *       custom {@code soso_controller} (see below).
 * </ul>
 *
 ...
 * configurations, you can define {@code soso_styled_player_view.xml} layout files in your
 * application {@code res/layout*} directories. These layouts will override the one provided by the
 * ExoPlayer library, and will be inflated for use by StyledPlayerView. The view identifies and
 * binds its children by looking for the following ids:
 *
 * <ul>
 *   <li><b>{@code soso_content_frame}</b> - A frame whose aspect ratio is resized based on the video
 ...
 *       </ul>
 *   <li><b>{@code soso_shutter}</b> - A view that's made visible when video should be hidden. This
 ...
 *         <li>Type: {@link View}
 *       </ul>
 *   <li><b>{@code soso_buffering}</b> - A view that's made visible when the player is buffering.
 *       This view typically displays a buffering spinner or animation.
 *       <ul>
 *         <li>Type: {@link View}
 *       </ul>
 *   <li><b>{@code soso_subtitles}</b> - Displays subtitles.
 *       <ul>
 *         <li>Type: {@link SubtitleView}
 *       </ul>
 *   <li><b>{@code soso_artwork}</b> - Displays album art.
 *       <ul>
 *         <li>Type: {@link ImageView}
 *       </ul>
 *   <li><b>{@code soso_error_message}</b> - Displays an error message to the user if playback fails.
 *       <ul>
 *         <li>Type: {@link TextView}
 *       </ul>
 *   <li><b>{@code soso_controller_placeholder}</b> - A placeholder that's replaced with the inflated
 *       {@link StyledPlayerControlView}. Ignored if an {@code soso_controller} view exists.
 *       <ul>
 *         <li>Type: {@link View}
 *       </ul>
 *   <li><b>{@code soso_controller}</b> - An already inflated {@link StyledPlayerControlView}. Allows
 ...
 *       id, any {@code soso_controller_placeholder} view will be ignored.
 *       <ul>
 *         <li>Type: {@link StyledPlayerControlView}
 *       </ul>
 *   <li><b>{@code soso_ad_overlay}</b> - A {@link FrameLayout} positioned on top of the player which
 *       is used to show ad UI (if applicable).
 *       <ul>
 *         <li>Type: {@link FrameLayout}
 *       </ul>
 *   <li><b>{@code soso_overlay}</b> - A {@link FrameLayout} positioned on top of the player which
 ...
 *
 * Defining your own {@code soso_styled_player_view.xml} is useful to customize the layout of
 ...
 * {@code soso_styled_player_view.xml} for only the instance on which the attribute is set.
 */
public class StyledPlayerView extends FrameLayout implements AdsLoader.AdViewProvider {
  ...
  public StyledPlayerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    int shutterColor = 0;
    int playerLayoutId = R.layout.soso_styled_player_view;
    ...
    int showBuffering = SHOW_BUFFERING_ALWAYS;
    ...
    // Content frame.
    contentFrame = findViewById(R.id.soso_content_frame);
    if (contentFrame != null) {
      setResizeModeRaw(contentFrame, resizeMode);
    }

    // Shutter view.
    shutterView = findViewById(R.id.soso_shutter);
    ...
    adOverlayFrameLayout = findViewById(R.id.soso_ad_overlay);

    // Overlay frame layout.
    overlayFrameLayout = findViewById(R.id.soso_overlay);

    // Artwork view.
    artworkView = findViewById(R.id.soso_artwork);
    ...
    // Subtitle view.
    subtitleView = findViewById(R.id.soso_subtitles);
    ...
    // Buffering view.
    bufferingView = findViewById(R.id.soso_buffering);
    ...
    // Error message view.
    errorMessageView = findViewById(R.id.soso_error_message);
    if (errorMessageView != null) {
      errorMessageView.setVisibility(View.GONE);
    }


    View controllerPlaceholder = findViewById(R.id.soso_controller_placeholder);
  ...
  /**
   * Sets the background color of the {@code soso_shutter} view.
   *
   ...
   * the player is reset. Note that the video frame is hidden by making {@code soso_shutter} visible.
  ...
  public void setOnButtonClickEventListener(StyledPlayerControlView.OnButtonClickEventListener listener) {
    Assertions.checkStateNotNull(controller);
    controller.setOnButtonClickEventListener(listener);
  }

  public void updateAnotherFileButton(int curIndex,  ArrayList<? extends Object > mediaItems) {
    Assertions.checkStateNotNull(controller);
    controller.updateAnotherFileButton(curIndex, mediaItems);
  }
  /**
...
//      Assertions.checkStateNotNull(controller);
//      conroller.setShowShuffleButton(showShuffleButton);
//  }
//
//  /**
...
//  }
  ...
  public ViewGroup getAdViewGroup() {
    return Assertions.checkStateNotNull(
        adOverlayFrameLayout, "soso_ad_overlay must be present for ad playback");
  }
    ...
    if (controller == null || !useController) {
      ...
      setContentDescription(
          /* contentDescription= */ controllerHideOnTouch
              ? getResources().getString(R.string.soso_controls_hide)
              : null);
    } else {
      setContentDescription(
          /* contentDescription= */ getResources().getString(R.string.soso_controls_show));
    }
  }
  ...
  private static void configureEditModeLogoV23(Resources resources, ImageView logo) {
    logo.setImageDrawable(resources.getDrawable(R.drawable.soso_edit_mode_logo, null));
    logo.setBackgroundColor(resources.getColor(R.color.soso_edit_mode_background_color, null));
  }

  private static void configureEditModeLogo(Resources resources, ImageView logo) {
    logo.setImageDrawable(resources.getDrawable(R.drawable.soso_edit_mode_logo));
    logo.setBackgroundColor(resources.getColor(R.color.soso_edit_mode_background_color));
  }
  ...
  public void setDefaultPlaybackSpeed(float loadLastPlaybackSpeed) {
    controller.setDefaultPlaybackSpeed(loadLastPlaybackSpeed);
  }
}
